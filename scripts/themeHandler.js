...
function changeSecondaryPlayIconsToDarkMode(darkThemeChecker) {
    ...
    for (let index = 0; index < secondaryPlayIcons.length; index++) {
        ...
        if (playIcon.getAttribute("src") == "themes/default/icons/play_button.png" && darkThemeChecker) {
            playIcon.setAttribute("src", "themes/dark/icons/play_button.png");
        }
        else if (!darkThemeChecker) {
            playIcon.setAttribute("src", "themes/default/icons/play_button.png");
        }
    }
}
...
function uploadTheme() {
    ...
    if (cssFile.value) {
        ...
        //span
        let spanElement = document.createElement("label");
        spanElement.setAttribute("class", "down-margin-theme");

        //label
        let labelElement = document.createElement("label");
        labelElement.setAttribute("class", "text-font-deafult");
...
function setTheme() {
    ...
    if (selectedTheme == "dark-theme.css") {
        ...
        styleLink.setAttribute("href", ("themes/default/" + selectedTheme));
    }
